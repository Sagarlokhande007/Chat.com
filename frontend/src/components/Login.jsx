...
// loader after the login
import { Loader2 } from "lucide-react";  
// navigate for render home page
  ...
  return (
    <div className="flex items-center w-screen h-screen justify-center">
      ...
      >
        ...
        <span className="text-center">Dosent have an account? <a href="/signup" className="text-blue-600">Signup</a></span>
      </form>
    </div>
  );
}
